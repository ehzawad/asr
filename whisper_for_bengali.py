...
feature_extractor = WhisperFeatureExtractor.from_pretrained("openai/whisper-small") #small whisper model, we can use either medium or large
...
training_args = Seq2SeqTrainingArguments(
    output_dir="output/whisper-small-bn",  # change to a repo name of your choice
